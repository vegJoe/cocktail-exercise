...
Your are building a beer-wiki that uses data from [Punk API:et](https://punkapi.com/documentation/v2). The web application will have three different pages _(see further down for more information on each of the views)_.

### Requirements

Create the application using React Typescript.
